...
class Layout extends React.Component {
    ...
    render() {
        ...
        return (
            <>
                <Meta metaTitle={this.props.metaTitle} metaDescription={this.props.metaDescription} metaImage={this.props.metaImage || this.props.metaPageUrl + this.props.data.shareimage.childImageSharp.fixed.src} metaPageUrl={this.props.metaPageUrl} />
